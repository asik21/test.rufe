...
class FinalWin(QWidget):
       def __init__(self,exp):
              '''окно в котором проводиться опрос'''
              super().__init__()
              ...
              # устанавлеваем как будет выглядет окно
              self.set_appear
              #старт
              self.show()
       ...
       def results(self):
              ...
              if self.exp.age == 13 or self.exp.age == 14:
                     if self.index >= 16.5:
                            ...
                            return txt_res3
                     elif self.index < 7.5 and self.inddex >= 2:
                            return txt_res4
                     else: 
                            return txt_res5
              if self.exp.age >= 15:
